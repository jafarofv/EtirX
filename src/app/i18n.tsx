...
const dict: Dict = {
  ...
  "cart.promoApplied": { az: "Promokod checkout üçün yadda saxlanıldı.", en: "Promo code saved for checkout.", ru: "Промокод сохранён для оформления." },
  "cart.promoCleared": { az: "Promokod silindi.", en: "Promo code cleared.", ru: "Промокод удалён." },
  "cart.promoLoginRequired": { az: "Promokod tətbiqi üçün login tələb olunur.", en: "Login is required to apply a promo code.", ru: "Для применения промокода требуется вход." },
  ...
  "cart.shippingAtCheckout": { az: "Rəsmiləşdirmədə seçiləcək", en: "Selected during checkout", ru: "Выбирается при оформлении заказа" },
  ...
  "checkout.delivery.cityCourier": { az: "Şəhər daxili çatdırılma", en: "City delivery", ru: "Доставка по городу" },
  "checkout.delivery.cityCourierEta": { az: "Yango, Bolt və s.", en: "Yango, Bolt, etc.", ru: "Yango, Bolt и др." },
  "checkout.delivery.metroDrop": { az: "N.Nərimanov və Gənclik metrosuna çatdırılma", en: "Delivery to N.Narimanov or Ganjlik metro", ru: "Доставка до м. Н.Нариманов и Гянджлик" },
  "checkout.delivery.metroDropEta": { az: "Çatdırılma haqqı: 2 \u20BC", en: "Delivery fee: 2 \u20BC", ru: "Стоимость: 2 \u20BC" },
  "checkout.delivery.azerpost": { az: "AzerPoçt ilə göndəriş", en: "Shipping via Azerpost", ru: "Отправка Azerpost" },
  "checkout.delivery.azerpostEta": { az: "Çatdırılma haqqı: 3 \u20BC", en: "Delivery fee: 3 \u20BC", ru: "Стоимость: 3 \u20BC" },
  "checkout.delivery.pickup": { az: "Depodan təhvil alma", en: "Warehouse pickup", ru: "Самовывоз со склада" },
  ...
  "checkout.promo": { az: "Promokod (istəyə bağlı)", en: "Promo code (optional)", ru: "Промокод (необязательно)" },
  "checkout.promoLoginHint": { az: "Promokod üçün hesaba daxil olun.", en: "Login is required to use a promo code.", ru: "Для промокода требуется вход в аккаунт." },
  ...
  "checkout.deliveryRequiredError": { az: "Çatdırılma üsulunu seçin.", en: "Please select a delivery method.", ru: "Выберите способ доставки." },
  "checkout.promoLoginRequired": { az: "Promokod tətbiqi üçün əvvəlcə login edin.", en: "Please login first to apply a promo code.", ru: "Сначала войдите в аккаунт для применения промокода." },
  ...
  "profile.accountCreated": { az: "Hesab uğurla yaradıldı.", en: "Account created successfully.", ru: "Аккаунт успешно создан." },
  "profile.registerFailed": { az: "Qeydiyyat alınmadı.", en: "Registration failed.", ru: "Регистрация не удалась." },
  "profile.loginSuccess": { az: "Giriş uğurludur.", en: "Login successful.", ru: "Вход выполнен успешно." },
  "profile.addressNotSet": { az: "Ünvan qeyd edilməyib", en: "Address not set", ru: "Адрес не указан" },
  "profile.editProfile": { az: "Profili redaktə et", en: "Edit Profile", ru: "Редактировать профиль" },
  ...
  "profile.editTitle": { az: "Profili redaktə et", en: "Edit Profile", ru: "Редактировать профиль" },
  ...
  "profile.passwordUpdated": { az: "Şifrə yeniləndi.", en: "Password updated.", ru: "Пароль обновлён." },
  "profile.passwordUpdateFailed": { az: "Şifrə yenilənmədi.", en: "Could not change password.", ru: "Не удалось сменить пароль." },
  "profile.updatePasswordBtn": { az: "Şifrəni yenilə", en: "Update password", ru: "Обновить пароль" },
  "profile.authEnabled": { az: "Token əsaslı giriş aktivdir.", en: "Token-based auth enabled.", ru: "Токен-аутентификация включена." }
};
